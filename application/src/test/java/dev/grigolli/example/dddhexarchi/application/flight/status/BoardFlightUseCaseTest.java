...
class BoardFlightUseCaseTest extends UseCaseTest {

    @InjectMocks
    private DefaultBoardFlightUseCase useCase;
    ...
    void givenAValidCommand_whenCallExecute_thenFlightShouldBeBoarded() {
        ...
        Mockito.verify(flightGateway, Mockito.times(1)).update(
                Mockito.argThat(aFlight -> aFlight.getStatus().equals(FlightStatus.BOARDING))
        );
    }
