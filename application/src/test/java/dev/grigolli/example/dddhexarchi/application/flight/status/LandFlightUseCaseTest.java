...
class LandFlightUseCaseTest extends UseCaseTest {

    @InjectMocks
    private DefaultLandFlightUseCase useCase;
    ...
    @Test
    void givenAValidCommand_whenCallExecute_thenFlightShouldBeLanded() {
        // given
        ...
        Mockito.verify(flightGateway, Mockito.times(1)).update(
                Mockito.argThat(aFlight -> aFlight.getStatus().equals(FlightStatus.LANDED))
        );
    }
