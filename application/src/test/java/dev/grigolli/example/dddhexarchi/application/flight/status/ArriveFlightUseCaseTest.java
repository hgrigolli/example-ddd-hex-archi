...
class ArriveFlightUseCaseTest extends UseCaseTest {

    @InjectMocks
    private DefaultArriveFlightUseCase useCase;
    ...
    @Test
    void givenAValidCommand_whenCallExecute_thenFlightShouldBeArrived() {
        // given
        ...
        Mockito.verify(flightGateway, Mockito.times(1)).update(
                Mockito.argThat(aFlight -> aFlight.getStatus().equals(FlightStatus.ARRIVED))
        );
    }
