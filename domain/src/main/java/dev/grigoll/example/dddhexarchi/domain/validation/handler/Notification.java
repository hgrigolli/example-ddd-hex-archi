package dev.grigoll.example.dddhexarchi.domain.validation.handler;


import dev.grigoll.example.dddhexarchi.domain.exceptions.DomainException;
import dev.grigoll.example.dddhexarchi.domain.validation.DomainError;
import dev.grigoll.example.dddhexarchi.domain.validation.ValidationHandler;
